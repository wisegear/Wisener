...
<div class="comments-section">
    ...
    @can('Member')
        <form action="{{ route('comments.store') }}" method="POST">
            ...
            <button type="submit" class="border rounded p-2 mt-2 bg-slate-500 text-white text-sm hover:bg-slate-400 dark:border-gray-700">Submit Comment</button>
        </form>
    @endcan
    @guest
        <div class="mt-4 font-bold">
            <p class="dark:text-white">Want to comment on this page? <a href="/login" class="text-teal-700">Login</a> or <a href="/register" class="text-teal-700">Register</a>.</p>
        </div>
    @endguest
</div>