...
@section('content')
    ...
    <div class=""> 
        <!-- Header section -->
        <header>
            <div class="mt-20 md:w-full lg:w-10/12">
            ...
            <main class="my-20 flex flex-col md:flex-row gap-24">
                ...
                <div class="md:w-5/12 text-sm p-2">
                    ...
                    <p class="mb-4 text-zinc-500">It feels odd having to say this, but, no AI was used in creating the content on this site.  With so much of the internet being dominated by AI generated content these days
                        it's hard to tell. </p>
                    <p class="text-zinc-500">Go have a look at some of my articles, either my grammar and spelling are bad or AI is not as good as people think it is!  Although I have started using Grammarly, it's for your benefit!</p>
                </div>
            </main>
        </div>
    </div>
